(function($){
      ...
      var html = [
        '<div id="' + id + '" class="article-share-box">',
          ...
          '<div class="article-share-links">',
            ...
            '<a href="http://service.weibo.com/share/share.php?&title=' + encodedUrl + '" class="article-share-sina" target="_blank" title="Sina Weibo"></a>',
  ...
  //read more
  $(".article-more-link a").click(function(){
